...
from ansible_collections.netapp.netapp.plugins.modules.na_ontap_autosupport \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.netapp.netapp.plugins.modules.na_ontap_autosupport.NetAppONTAPasup.get_autosupport_config')
    ...
    @patch('ansible_collections.netapp.netapp.plugins.modules.na_ontap_autosupport.NetAppONTAPasup.modify_autosupport_config')
