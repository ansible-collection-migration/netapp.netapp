...
from ansible_collections.netapp.netapp.plugins.modules.na_ontap_cluster \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.netapp.netapp.plugins.modules.na_ontap_cluster.NetAppONTAPCluster.create_cluster')
