...
from ansible_collections.netapp.netapp.plugins.modules.na_ontap_dns \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.netapp.netapp.plugins.module_utils.netapp.OntapRestAPI.send_request')
