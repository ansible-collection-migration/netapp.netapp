...
from ansible_collections.netapp.netapp.plugins.modules.na_ontap_kerberos_realm \
...
from ansible_collections.netapp.netapp.tests.unit.compat.mock import Mock
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.netapp.netapp.plugins.modules.na_ontap_kerberos_realm.NetAppOntapKerberosRealm.delete_krbrealm')
    ...
    @patch('ansible_collections.netapp.netapp.plugins.modules.na_ontap_kerberos_realm.NetAppOntapKerberosRealm.create_krbrealm')
