...
from ansible_collections.netapp.netapp.plugins.modules.na_ontap_ndmp \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.netapp.netapp.plugins.modules.na_ontap_ndmp.NetAppONTAPNdmp.ndmp_get_iter')
