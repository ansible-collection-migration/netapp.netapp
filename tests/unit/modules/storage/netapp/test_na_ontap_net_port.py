...
from ansible_collections.netapp.netapp.plugins.modules.na_ontap_net_port \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.netapp.netapp.plugins.modules.na_ontap_net_port.NetAppOntapNetPort.get_net_port')
