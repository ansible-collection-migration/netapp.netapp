...
from ansible_collections.netapp.netapp.plugins.modules.na_ontap_net_routes \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.netapp.netapp.plugins.modules.na_ontap_net_routes.NetAppOntapNetRoutes.create_net_route')
    ...
    @patch('ansible_collections.netapp.netapp.plugins.modules.na_ontap_net_routes.NetAppOntapNetRoutes.get_net_route')
