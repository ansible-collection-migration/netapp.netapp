...
from ansible_collections.netapp.netapp.plugins.modules.na_ontap_net_subnet \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.netapp.netapp.plugins.module_utils.netapp.ems_log_event')
    @patch('ansible_collections.netapp.netapp.plugins.modules.na_ontap_net_subnet.NetAppOntapSubnet.create_subnet')
    ...
    @patch('ansible_collections.netapp.netapp.plugins.module_utils.netapp.ems_log_event')
    @patch('ansible_collections.netapp.netapp.plugins.modules.na_ontap_net_subnet.NetAppOntapSubnet.rename_subnet')
    ...
    @patch('ansible_collections.netapp.netapp.plugins.module_utils.netapp.ems_log_event')
    @patch('ansible_collections.netapp.netapp.plugins.modules.na_ontap_net_subnet.NetAppOntapSubnet.delete_subnet')
