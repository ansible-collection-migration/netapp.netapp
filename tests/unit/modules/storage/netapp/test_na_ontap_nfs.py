...
from ansible_collections.netapp.netapp.plugins.modules.na_ontap_nfs \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.netapp.netapp.plugins.modules.na_ontap_nfs.NetAppONTAPNFS.delete_nfs')
    ...
    @patch('ansible_collections.netapp.netapp.plugins.modules.na_ontap_nfs.NetAppONTAPNFS.get_nfs_service')
