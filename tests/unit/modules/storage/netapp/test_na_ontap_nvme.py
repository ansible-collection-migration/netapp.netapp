...
from ansible_collections.netapp.netapp.plugins.modules.na_ontap_nvme \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.netapp.netapp.plugins.modules.na_ontap_nvme.NetAppONTAPNVMe.create_nvme')
    ...
    @patch('ansible_collections.netapp.netapp.plugins.modules.na_ontap_nvme.NetAppONTAPNVMe.delete_nvme')
    ...
    @patch('ansible_collections.netapp.netapp.plugins.modules.na_ontap_nvme.NetAppONTAPNVMe.modify_nvme')
