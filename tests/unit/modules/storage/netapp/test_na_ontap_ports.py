...
from ansible_collections.netapp.netapp.plugins.modules.na_ontap_ports \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.netapp.netapp.plugins.modules.na_ontap_ports.NetAppOntapPorts.add_broadcast_domain_ports')
    @patch('ansible_collections.netapp.netapp.plugins.modules.na_ontap_ports.NetAppOntapPorts.get_broadcast_domain_ports')
    ...
    @patch('ansible_collections.netapp.netapp.plugins.modules.na_ontap_ports.NetAppOntapPorts.add_portset_ports')
    @patch('ansible_collections.netapp.netapp.plugins.modules.na_ontap_ports.NetAppOntapPorts.portset_get')
