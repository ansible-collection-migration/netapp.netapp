...
from ansible_collections.netapp.netapp.plugins.modules.na_ontap_security_key_manager \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.netapp.netapp.plugins.modules.na_ontap_security_key_manager.NetAppOntapSecurityKeyManager.get_key_manager')
