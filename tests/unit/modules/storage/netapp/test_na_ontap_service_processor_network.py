...
from ansible_collections.netapp.netapp.plugins.modules.na_ontap_service_processor_network \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.netapp.netapp.plugins.modules.na_ontap_service_processor_network.NetAppOntapServiceProcessorNetwork.'
