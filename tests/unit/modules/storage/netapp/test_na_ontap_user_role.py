...
from ansible_collections.netapp.netapp.plugins.modules.na_ontap_user_role \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.netapp.netapp.plugins.modules.na_ontap_user_role.NetAppOntapUserRole.get_role')
