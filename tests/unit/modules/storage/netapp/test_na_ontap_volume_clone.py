...
from ansible_collections.netapp.netapp.plugins.modules.na_ontap_volume_clone \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.netapp.netapp.plugins.modules.na_ontap_volume_clone.NetAppONTAPVolumeClone.create_volume_clone')
