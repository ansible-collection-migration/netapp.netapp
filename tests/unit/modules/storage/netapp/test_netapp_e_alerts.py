...
from ansible_collections.netapp.netapp.plugins.modules.netapp_e_alerts import Alerts
...
__metaclass__ = type
from ansible_collections.netapp.netapp.tests.unit.compat import mock
...
class AlertsTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.netapp.netapp.plugins.modules.netapp_e_alerts.request'
