...
from ansible_collections.netapp.netapp.plugins.modules.netapp_e_asup import Asup
...
class AsupTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.netapp.netapp.plugins.modules.netapp_e_asup.request'
