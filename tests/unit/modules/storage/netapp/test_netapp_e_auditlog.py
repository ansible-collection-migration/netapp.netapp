...
from ansible_collections.netapp.netapp.plugins.modules.netapp_e_auditlog import AuditLog
...
class AuditLogTests(ModuleTestCase):
    REQUIRED_PARAMS = {'api_username': 'rw',
                       ...
                       'ssid': '1'}
    REQ_FUNC = 'ansible_collections.netapp.netapp.plugins.modules.netapp_e_auditlog.request'
