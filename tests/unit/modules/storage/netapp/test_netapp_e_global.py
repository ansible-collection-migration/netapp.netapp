...
from ansible_collections.netapp.netapp.plugins.modules.netapp_e_global import GlobalSettings
...
class GlobalSettingsTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.netapp.netapp.plugins.modules.netapp_e_global.request'
