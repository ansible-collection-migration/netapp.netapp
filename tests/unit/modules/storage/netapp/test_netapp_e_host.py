...
from ansible_collections.netapp.netapp.plugins.modules.netapp_e_host import Host
...
class HostTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.netapp.netapp.plugins.modules.netapp_e_host.request'
