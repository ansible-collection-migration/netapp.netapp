...
from ansible_collections.netapp.netapp.plugins.modules.netapp_e_iscsi_interface import IscsiInterface
...
class IscsiInterfaceTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.netapp.netapp.plugins.modules.netapp_e_iscsi_interface.request'
