...
from ansible_collections.netapp.netapp.plugins.modules.netapp_e_iscsi_target import IscsiTarget
...
class IscsiTargetTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.netapp.netapp.plugins.modules.netapp_e_iscsi_target.request'
