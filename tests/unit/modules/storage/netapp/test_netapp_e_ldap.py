...
from ansible_collections.netapp.netapp.plugins.modules.netapp_e_ldap import Ldap
from ansible_collections.netapp.netapp.tests.unit.modules.utils import ModuleTestCase, set_module_args, AnsibleFailJson, AnsibleExitJson
...
class LdapTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.netapp.netapp.plugins.modules.netapp_e_ldap.request'
