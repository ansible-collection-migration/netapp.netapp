...
from ansible_collections.netapp.netapp.plugins.modules.netapp_e_mgmt_interface import MgmtInterface
...
import mock
from ansible_collections.netapp.netapp.tests.unit.compat.mock import PropertyMock
...
class MgmtInterfaceTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.netapp.netapp.plugins.modules.netapp_e_mgmt_interface.request'
