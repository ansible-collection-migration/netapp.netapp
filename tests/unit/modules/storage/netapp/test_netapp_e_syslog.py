...
from ansible_collections.netapp.netapp.plugins.modules.netapp_e_syslog import Syslog
...
class AsupTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.netapp.netapp.plugins.modules.netapp_e_syslog.request'
